...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            if(temp.data) {
                me.list = temp.data._embedded.freightDeliveries;
            }

            if(me.value && typeof me.value == "object" && Object.values(me.value)[0]) {
                var id = Object.values(me.value)[0];
                var tmpValue = await axios.get(axios.fixUrl('/freightDeliveries/' + id))
                if(tmpValue.data) {
